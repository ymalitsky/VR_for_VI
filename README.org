* About
This is the supplementary code (in Julia) for the paper [[http://arxiv.org/abs/2102.08352]["Stochastic Variance Reduction for Variational Inequality Methods"]] by Ahmet
